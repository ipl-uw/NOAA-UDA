...
writer = SummaryWriter('./logs/'+model_name+'finetune_1%')
save_path_val = './per img predictions val/'+model_name +'finetune_1%'
save_path_tr = './per img predictions train/'+model_name +'finetune_1%'
...
valid_gt_path = '/home/jiemei/Documents/vit_for_rail/test_sleeper_shark/results/combined_unlabeled_target_data_10gt.csv'
train_gt_path = '/home/jiemei/Documents/vit_for_rail/test_sleeper_shark/results/combined_unlabeled_target_data_10gt_1%.csv'
uda_img_dir = ''


target_dataset = Fish_Rail_Tracking_Result(csv_path=train_gt_path,
                                        img_dir=uda_img_dir,
...
train_loader = DataLoaderX(dataset=target_dataset,
                         batch_size=BATCH_SIZE,
                         shuffle=True,
                         num_workers=0,
                         drop_last=True)

target_eval_dataset = Fish_Rail_Tracking_Result(csv_path=valid_gt_path,
                                        img_dir=uda_img_dir,
                                        transform=custom_transform_val,
                                        crop=True,
                                        return_label=True)
